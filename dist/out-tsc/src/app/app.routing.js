...
export var routes = [
    ...
    },
    {
        ...
        children: [
            {
                path: 'role',
                loadChildren: function () { return import('./custom/role/role.module').then(function (m) { return m.RoleModule; }); }
            },
            {
                path: 'location',
                loadChildren: function () { return import('./custom/location/location.module').then(function (m) { return m.LocationModule; }); }
            },
            {
                path: 'organisation',
                loadChildren: function () { return import('./custom/organization/organization.module').then(function (m) { return m.OrganisationModule; }); }
            },
            {
                path: 'base',
